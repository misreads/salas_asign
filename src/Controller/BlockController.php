...
class BlockController extends Controller
{
    ...
    {
        return $this->render('block/index.html.twig', ['blocks' => $blockRepository->findAll()]);
    }
    ...
    {
        return $this->render('block/show.html.twig', ['block' => $block]);
    }
    ...
    public function edit(Request $request, Block $block): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('block_edit', ['id' => $block->getId()]);
        }
